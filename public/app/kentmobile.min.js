...
app.regSubApp({
	...
	title: 'Maps',
	iconTitle: 'Maps',
	helptext: "<p>The purpose of this app is to help Students navigate the Kent Campus.</p><p>If you have any ideas, suggestions, or feedback whether it is positive or negative regarding the Kent Mobile Maps application we would be extremely grateful if you would complete our feedback form. We are keen to hear about your personal user experience.</p><p>Our maps data is being provided by the Open Street Map project, and there is an on going project to improve the detail and accuracy of our campus maps.</p>",
	listeners: {
		launch: function () {
...
app.regSubApp({
	...
	title: 'Travel',
	iconTitle: 'Travel',
	helptext: "<p>Here are some other sites that you might find useful when travelling to the University.</p>",
	listeners: {
		launch: function () {
		},
		activate: function () {
...
app.regSubApp({
	...
	iconTitle: 'Social',
	helptext: "<p>Connect with Kent using social media</p>",
	listeners: {
		launch: function () {
		},
		activate: function () {
...
app.regLauncher({
	name: 'a2zLauncher',
	title: 'Launch Departments A-Z',
	iconTitle: 'Departments',
	href: "http://www.kent.ac.uk/departments/atoz/",
	html: "<p>In the Mobile Devices Survey you said you'd like to communicate more with your departments and be able to access the contact information with ease on a Mobile Device.</p><p>We will investigate how these services might be delivered; in the meantime here is the link to the full site which may be accessible on your current smart phone.</p>"
});
...
app.regLauncher({
	...
	title: 'Launch Moodle',
	iconTitle: 'Moodle',
	href: "http://moodle.kent.ac.uk",
	html: "<p>In the Mobile Devices Survey you said you'd like to receive <strong>Assignment Deadlines</strong>, <strong>Lecture Slides</strong> and <strong>PDF/Word documents</strong> on a mobile device.</p><p>We will investigate how these services might be delivered; in the meantime here is the link to the full site which may be accessible on your current smart phone.</p>"
});
...
app.regLauncher({
	...
	title: 'Launch SDS',
	iconTitle: 'SDS',
	href: "https://sds.kent.ac.uk/",
	html: "<p>In the Mobile Devices Survey you said you'd like to receive <strong>Coursework Marks</strong>, <strong>Marks Alert</strong>, <strong>Results Release Alert</strong> and the <strong>Exam Timetable</strong> on a mobile device.</p><p>We will investigate how these services might be delivered; in the meantime here is the link to the full site which may be accessible on your current smart phone.</p>"
});

app.regLauncher({
	name: 'catalogueLaunch',
	title: 'Launch library catalogue',
	iconTitle: 'Catalogue',
	href: "http://catalogue.kent.ac.uk",
	html: "<p>In the Mobile Devices Survey you said you'd like to <strong>Search</strong>, <strong>Locate Classmarks</strong>, and <strong>Reserve a book</strong> on a mobile device.</p><p>We will investigate how these services might be delivered; in the meantime here is the link to the full site which may be accessible on your current smart phone.</p>"
});

app.regLauncher({
	name: 'mainSiteLaunch',
	title: 'Launch main website',
	iconTitle: 'Main Site',
	href: "http://www.kent.ac.uk",
	html: "<p>A lot of the information you requested on mobile device are already availble on the University's web site</p>We will be investigating how will can improve the main web site for mobile devices.</p>"
});
...
app.regSubApp({
	...
	title: 'Help',
	iconTitle: 'Help',
	defaultHelptext: "<p>The purpose of this app is to offer further advice or points of help contact to our Kent Mobile users specifically when on the move.<p></p>If you have any ideas, suggestions, or feedback whether it is positive or negative regarding the Kent Help application we would be extremely grateful if you would complete our feedback form. We are keen to hear about your personal user experience.</p>",
	listeners: {
		launch: function () {
		},
		activate: function () {
...
app.subapps.help.stores.connectivityCategories = new Ext.data.Store({
	model: 'ConnectivityCategories',
	data: [
  	{id: 'android', name: 'Android', url: 'http://blogs.kent.ac.uk/mobiledevices/category/android/feed/'},
  	{id: 'apple_os', name: 'Apple OS', url: 'http://blogs.kent.ac.uk/mobiledevices/category/apple-os/feed/'},
  	{id: 'blackberry', name: 'Blackberry', url: 'http://blogs.kent.ac.uk/mobiledevices/category/blackberry/feed/'},
  	{id: 'symbian', name: 'Symbian', url: 'http://blogs.kent.ac.uk/mobiledevices/category/symbian/feed/'},
  	{id: 'windows_mobile', name: 'Windows Mobile', url: 'http://blogs.kent.ac.uk/mobiledevices/category/windows-mobile/feed/'},
  	{id: 'connectmail', name: 'ConnectMail', url: 'http://blogs.kent.ac.uk/mobiledevices/category/connectmail/feed/'},
  	{id: 'liveedu', name: 'Live@edu', url: 'http://blogs.kent.ac.uk/mobiledevices/category/liveedu/feed/'},
  	{id: 'wifi_settings_at_kent', name: 'Wifi (eduroam)', url: 'http://blogs.kent.ac.uk/mobiledevices/category/wifi-settings-at-kent/feed/'},
	],
});
...
app.subapps.help.views.HelpHelptext = Ext.extend(Ext.Panel, {
	id: 'help_text',
	html: '',
	style: 'margin: 30px;',
});
...
/**
 *
 * @depend ../vendor/sencha/sencha-touch.js
 *
 * @depend config.js
 * @depend track.js
 * @depend app.js
 * @depend monkey.js
 * @depend routes.js
 * @depend subapps/SubApp.js
 * @depend subapps/Launcher.js
 * @depend views/Grid.js
 * @depend views/Leaflet.js
 * @depend views/SubAppToolbar.js
 * @depend views/NestedListWithHtmlLeaf.js
 * @depend views/Viewport.js
 * @depend views/LinkButton.js
 * @depend models/ListItem.js
 * @depend lib/distance.js
 *
 * @depend subapps/Maps/Maps.js
 * @depend subapps/Maps/models/Building.js
 * @depend subapps/Maps/models/Campus.js
 * @depend subapps/Maps/models/TravelInfo.js
 * @depend subapps/Maps/stores/buildings.js
 * @depend subapps/Maps/stores/campuses.js
 * @depend subapps/Maps/stores/travel.js
 * @depend subapps/Maps/controllers/MapsController.js
 * @depend subapps/Maps/views/MapsTravel.js
 * @depend subapps/Maps/views/MapsMap.js
 * @depend subapps/Maps/views/MapsBuildingsList.js
 * @depend subapps/Maps/views/MapsBuildingsBuilding.js
 * @depend subapps/Maps/views/MapsBuildings.js
 * @depend subapps/Maps/views/MapsCampusesList.js
 * @depend subapps/Maps/views/MapsCampusesCampus.js
 * @depend subapps/Maps/views/MapsCampuses.js
 * @depend subapps/Maps/views/MapsViewport.js
 *
 * @depend subapps/FreePc/FreePc.js
 * @depend subapps/FreePc/models/pcRoom.js
 * @depend subapps/FreePc/stores/pcRoomsStore.js
 * @depend subapps/FreePc/controllers/FreePcController.js
 * @depend subapps/FreePc/views/FreePcRoom.js
 * @depend subapps/FreePc/views/FreePcRooms.js
 * @depend subapps/FreePc/views/FreePcCampus.js
 * @depend subapps/FreePc/views/FreePcViewport.js
 *
 * @depend subapps/Timetable/Timetable.js
 * @depend subapps/Timetable/controllers/TimetableController.js
 * @depend subapps/Timetable/views/TimetableAuth.js
 * @depend subapps/Timetable/views/TimetableResult.js
 * @depend subapps/Timetable/views/TimetableAndroid.js
 * @depend subapps/Timetable/views/TimetableBB.js
 * @depend subapps/Timetable/views/TimetableViewport.js
 *
 * @depend subapps/FeedbackAlias/FeedbackAlias.js
 *
 * @depend subapps/Travel/Travel.js
 * @depend subapps/Travel/controllers/TravelController.js
 * @depend subapps/Travel/views/TravelViewport.js
 *
 * @depend subapps/Social/Social.js
 * @depend subapps/Social/controllers/SocialController.js
 * @depend subapps/Social/views/SocialViewport.js
 *
 * @depend subapps/Announcements/Announcement.js
 * @depend subapps/Announcements/models/RssFeed.js
 * @depend subapps/Announcements/stores/RssFeed.js
 * @depend subapps/Announcements/controllers/AnnouncementController.js
 * @depend subapps/Announcements/views/AnnouncementView.js
 * @depend subapps/Announcements/views/AnnouncementList.js
 * @depend subapps/Announcements/views/AnnouncementViewport.js
 *
 * @depend subapps/AppBrowser/AppBrowser.js
 * @depend subapps/AppBrowser/AppBrowserController.js
 * @depend subapps/AppBrowser/AppBrowserViewport.js
 * @depend subapps/AppBrowser/AppBrowserGridViewport.js
 * @depend subapps/A2ZLaunch/A2ZLaunch.js
 * @depend subapps/MoodleLaunch/MoodleLaunch.js
 * @depend subapps/SdsLaunch/SdsLaunch.js
 * @depend subapps/CatalogueLaunch/CatalogueLaunch.js
 * @depend subapps/MainSiteLaunch/MainSiteLaunch.js
 * @depend subapps/AppBrowser/views/LauncherWarning.js
 *
 * @depend subapps/Help/Help.js
 * @depend subapps/Help/models/ConnectivityFeed.js
 * @depend subapps/Help/stores/connectivityFeedStore.js
 * @depend subapps/Help/models/ConnectivityCategories.js
 * @depend subapps/Help/stores/connectivityCategories.js
 * @depend subapps/Help/models/Pages.js
 * @depend subapps/Help/stores/pages.js
 * @depend subapps/Help/controllers/HelpController.js
 * @depend subapps/Help/views/HelpHelptext.js
 * @depend subapps/Help/views/HelpForm.js
 * @depend subapps/Help/views/HelpInApp.js
 * @depend subapps/Help/views/HelpPages.js
 * @depend subapps/Help/views/HelpConnectivityDevice.js
 * @depend subapps/Help/views/HelpConnectivityDeviceDetails.js
 * @depend subapps/Help/views/HelpConnectivity.js
 * @depend subapps/Help/views/HelpFeedback.js
 * @depend subapps/Help/views/HelpMain.js
 * @depend subapps/Help/views/HelpViewport.js
 *
 */
